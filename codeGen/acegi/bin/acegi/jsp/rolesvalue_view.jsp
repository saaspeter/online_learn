...
<html:html lang="true">
  <head>
    <html:base />
    <title><bean:message key="acegi.page.{[#folder#]}.rolesvalue_view.jsp.title"/></title>
	  ...
	  <div id="fieldDisDiv">
	     <ul>
		    ...
		    <li>
			   ...
			   <div class="field"> 
			      <bean:write name="rolesvalueForm" property="vo.id"/>
			   </div>
		    ...
		    <li>
			   ...
			   <div class="field"> 
			      <bean:write name="rolesvalueForm" property="vo.localeid"/>
			   </div>
			   <div class="fieldDesc"></div>
			</li>
		    ...
		    <li>
			   ...
			   <div class="field"> 
			      <bean:write name="rolesvalueForm" property="vo.name"/>
			   </div>
			   <div class="fieldDesc"></div>
			</li>
		    ...
		    <li>
			   ...
			   <div class="field"> 
			      <bean:write name="rolesvalueForm" property="vo.shopid"/>
			   </div>
			   <div class="fieldDesc"></div>
			</li>
