...
<html:html lang="true">
  <head>
    <html:base />
    <title><bean:message key="acegi.page.{[#folder#]}.role_resc_addEdit.jsp.title"/></title>
  ...
  <body>
	<div class="editPage">
	<html:form styleId="editForm" action="/{[#folder#]}/role_resc.do?method=save" method="post">
	 ...
	 <input type="hidden" name="vo.{[#pkName#]}" value="<bean:write name="role_rescForm" property="vo.{[#pkName#]}"/>">
	  ...
	  <div id="fieldDisDiv">
	     <ul>
		    ...
		    <li>
			   <div class="fieldLabel"><bean:message key="acegi.page.{[#folder#]}.role_resc.rescId"/>:</div>
			   <div class="field"> 
			     <input type="text" name="vo.rescId" value="<bean:write name="role_rescForm" property="vo.rescId"/>"/>
			   </div>
		    ...
		    <li>
			   <div class="fieldLabel"><bean:message key="acegi.page.{[#folder#]}.role_resc.roleId"/>:</div>
			   <div class="field"> 
			     <input type="text" name="vo.roleId" value="<bean:write name="role_rescForm" property="vo.roleId"/>"/>
			   </div>
			   <div class="fieldDesc"></div>
			</li>
