...
public class MenusDaoImpl extends BaseDao implements MenusDao {
    ...
    public Menus selectByPK(Long pk){
    	if(pk==null)
    		return null;
		Menus record = (Menus) this.queryForObject("Menus.selectByPK", pk);
		return record;
    }
    ...
    public Long insert(Menus record){
    	if(record==null)
    		return null;
		return (Long)super.insert("Menus.insert", record);
    }
    ...
    public int updateByPK(Menus record){
    	if(record==null||record.getId()==null)
    		return 0;
		int rows = super.update("Menus.updateByPK", record);
		return rows;
    }
    ...
    public int deleteByPK(Long pk){
    	if(pk==null)
    		return 0;
		int rows = super.delete("Menus.deleteByPK", pk);
		return rows;
    }
    ...
    public int insertBatch(List list){
    	if(list==null||list.size()<=0)
    		return 0;
    	int rows = 0;
       	rows = super.insertBatch("Menus.insert", list);
       	return rows;
    }
    ...
    public int updateBatch(List list){
    	if(list==null||list.size()<=0)
    		return 0;
    	int rows = 0;
       	rows = super.updateBatch("Menus.updateByPK", list);
       	return rows;
    }
    ...
    public int deleteBatchByPK(Long[] pkArray){
    	if(pkArray==null||pkArray.length<=0)
    		return 0;
    	int rows = 0;
       	rows = super.deleteBatch("Menus.deleteByPK", pkArray);
       	return rows;
    }
