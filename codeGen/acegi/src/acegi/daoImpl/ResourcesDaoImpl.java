...
public class ResourcesDaoImpl extends BaseDao implements ResourcesDao {
    ...
    public Resources selectByPK(Long pk){
    	if(pk==null)
    		return null;
		Resources record = (Resources) this.queryForObject("Resources.selectByPK", pk);
		return record;
    }
    ...
    public Long insert(Resources record){
    	if(record==null)
    		return null;
		return (Long)super.insert("Resources.insert", record);
    }
    ...
    public int updateBatch(List list){
    	if(list==null||list.size()<=0)
    		return 0;
    	int rows = 0;
       	rows = super.updateBatch("Resources.updateByPK", list);
       	return rows;
    }
    ...
    public int deleteBatchByPK(Long[] pkArray){
    	if(pkArray==null||pkArray.length<=0)
    		return 0;
    	int rows = 0;
       	rows = super.deleteBatch("Resources.deleteByPK", pkArray);
       	return rows;
    }
