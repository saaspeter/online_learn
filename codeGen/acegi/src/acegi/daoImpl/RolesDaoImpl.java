...
public class RolesDaoImpl extends BaseDao implements RolesDao {
    ...
    public List selectByVO(RolesQuery queryVO){
		if(queryVO==null)
			return selectAll();
		List list = this.queryForList("Roles.selectByVO", queryVO);
		return list;
    }
     ...
     * @throws Exception
     */
    public Page selectByVOPage(RolesQuery queryVO,int pageIndex,int pageSize){
        if(pageIndex<=0)
        	pageIndex = 1;
        if(pageSize<=0)
        ...
        String sqlStr = "";
        if(queryVO==null)
        	sqlStr = "Roles.selectAll";
        else 
        	sqlStr = "Roles.selectByVO";
    ...
    public Long insert(Roles record){
    	if(record==null)
    		return null;
		return (Long)super.insert("Roles.insert", record);
    }
    ...
    public int deleteBatchByPK(Long[] pkArray){
    	if(pkArray==null||pkArray.length<=0)
    		return 0;
    	int rows = 0;
       	rows = super.deleteBatch("Roles.deleteByPK", pkArray);
       	return rows;
    }
