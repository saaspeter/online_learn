...
<html:html lang="true">
  <head>
    <html:base />
    <title><bean:message key="acegi.page.{[#folder#]}.roles_list.jsp.title"/></title>
  ...
  <body>
  <div class="listPage">
  <html:form styleId="list" action="/{[#folder#]}/roles.do?method=list" method="post">
  ...
  <div id="firstLineDiv">
      ...
      <div id="searchDiv"><bean:message key="acegi.page.{[#folder#]}.roles.{[#searchColumn#]}"/>: 
		<input type="text" name="queryVO.{[#searchColumn#]}" value="<bean:write name="rolesForm" property="queryVO.{[#searchColumn#]}"/>"/>
  ...
  <div id="DataTableDiv">
    <table class="listDataTable" >
      <tr class="listDataTableHead">
        ...
        <td><bean:message key="acegi.page.{[#folder#]}.roles.name"/></td>

        <td><bean:message key="acegi.page.{[#folder#]}.roles.shopid"/></td>

        <td><bean:message key="acegi.page.{[#folder#]}.roles.syscode"/></td>

        <td><bean:message key="acegi.page.{[#folder#]}.roles.upid"/></td>

        <td><bean:message key="acegi.page.{[#folder#]}.roles.status"/></td>

        <td><bean:message key="acegi.page.{[#folder#]}.roles.isdefaultset"/></td>

        <td><bean:message key="acegi.page.{[#folder#]}.roles.descn"/></td>
      ...
      <tr>
        ...
        <a href="javascript:newDiv('/{[#folder#]}/roles.do?method=editPage&queryVO.id=<bean:write name="vo" property="id"/>&editType=<%=WebConstant.editType_view %>',0,1,600,400);"><bean:write name="vo" property="{[#searchColumn#]}"/></a>
        ...
        <td><bean:write name="vo" property="isdefaultset"/></td>
  ...
  <script language=JavaScript>
	 <!--
       window.onload=function(){
		    changeComplexSearch("complexSearchDiv","<bean:write name="rolesForm" property="complexSearchDivStatus"/>");
	        setListTableStyle();
	   }
     //-->
  </script>
