...
<html:html lang="true">
  <head>
    <html:base />
    <title><bean:message key="acegi.page.{[#folder#]}.resourcesvalue_addEdit.jsp.title"/></title>
  ...
  <body>
	<div class="editPage">
	<html:form styleId="editForm" action="/{[#folder#]}/resourcesvalue.do?method=save" method="post">
	 ...
	 <input type="hidden" name="vo.rescvalueid" value="<bean:write name="resourcesvalueForm" property="vo.rescvalueid"/>">
	  ...
	  <div id="fieldDisDiv">
	     <ul>
		    ...
		    <li>
			   <div class="fieldLabel"><bean:message key="acegi.page.{[#folder#]}.resourcesvalue.id"/>:</div>
			   <div class="field"> 
			     <input type="text" name="vo.id" value="<bean:write name="resourcesvalueForm" property="vo.id"/>"/>
			   </div>
		    ...
		    <li>
			   <div class="fieldLabel"><bean:message key="acegi.page.{[#folder#]}.resourcesvalue.localeid"/>:</div>
			   <div class="field"> 
			     <input type="text" name="vo.localeid" value="<bean:write name="resourcesvalueForm" property="vo.localeid"/>"/>
			   </div>
			   <div class="fieldDesc"></div>
			</li>
		    ...
		    <li>
			   <div class="fieldLabel"><bean:message key="acegi.page.{[#folder#]}.resourcesvalue.name"/>:</div>
			   <div class="field"> 
