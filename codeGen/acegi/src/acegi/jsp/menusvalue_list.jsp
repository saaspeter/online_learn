...
<html:html lang="true">
  <head>
    <html:base />
    <title><bean:message key="acegi.page.{[#folder#]}.menusvalue_list.jsp.title"/></title>
  ...
  <body>
  <div class="listPage">
  <html:form styleId="list" action="/{[#folder#]}/menusvalue.do?method=list" method="post">
  ...
  <div id="firstLineDiv">
      ...
      <div id="searchDiv"><bean:message key="acegi.page.{[#folder#]}.menusvalue.{[#searchColumn#]}"/>: 
		<input type="text" name="queryVO.{[#searchColumn#]}" value="<bean:write name="menusvalueForm" property="queryVO.{[#searchColumn#]}"/>"/>
  ...
  <div id="functionLineDiv">
	  <div id="functionButtonDiv">
		  <ul>
			 <li><button onclick="addRecord('/{[#folder#]}/menusvalue.do?method=addPage');return false;"><bean:message key="acegi.commonpage.add"/></button></li>
			 <li><button onclick="modifyRecord('list','keys','/{[#folder#]}/menusvalue.do?method=editPage&editType=<%=WebConstant.editType_edit %>&queryVO.menuvalueid=','<bean:message key="commonWeb.js.pageAction.modifyRecord.selectOneMsg" bundle="BaseKey"/>','<bean:message key="commonWeb.js.pageAction.modifyRecord.oneOnlyMsg" bundle="BaseKey"/>');return false;"><bean:message key="acegi.commonpage.modify"/></button></li>
			 <li><button onclick="deleteRecord('list','keys','/{[#folder#]}/menusvalue.do?method=delete','<bean:message key="commonWeb.js.pageAction.deleteRecord.selectOneMsg" bundle="BaseKey"/>','<bean:message key="commonWeb.js.pageAction.deleteRecord.confirmDeleteMsg" bundle="BaseKey"/>');return false;"><bean:message key="acegi.commonpage.delete"/></button></li>
  ...
  <div id="DataTableDiv">
    <table class="listDataTable" >
      <tr class="listDataTableHead">
        ...
        <td><bean:message key="acegi.page.{[#folder#]}.menusvalue.id"/></td>

        <td><bean:message key="acegi.page.{[#folder#]}.menusvalue.localeid"/></td>

        <td><bean:message key="acegi.page.{[#folder#]}.menusvalue.title"/></td>

        <td><bean:message key="acegi.page.{[#folder#]}.menusvalue.tooltip"/></td>
      ...
      <tr>
        ...
        <a href="javascript:newDiv('/{[#folder#]}/menusvalue.do?method=editPage&queryVO.menuvalueid=<bean:write name="vo" property="menuvalueid"/>&editType=<%=WebConstant.editType_view %>',0,1,600,400);"><bean:write name="vo" property="{[#searchColumn#]}"/></a>
