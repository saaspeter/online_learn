...
<html:html lang="true">
  <head>
    ...
    <bean:define id="validatecodeCheck" name="tenantForm" property="validatecodeCheck" type="java.lang.String"/>
  ...
  <body>
	...
	<div id="fieldsTitleDiv" class="centerstyle" style="margin-top:20px;margin-bottom:20px;background-color:#eeeeee;font-size:25px;text-align: center">机构注册</div>
	<html:form styleId="editForm" action="/customers/registerTenant.do" method="post">
	 ...
	 <input type="hidden" name="contactinfo.contactinfoid" value="<bean:write name="tenantForm" property="contactinfo.contactinfoid"/>"/> 
	  ...
	  <div class="userinput_div">
	     ...
	     <table cellspacing="7" cellpadding="0" border="0" width="100%">
			...
			<tr>
			   <td class="field_left"><font color="#ff0000">*</font>机构名称:</td>
			   <td class="login_field"><input id="nameId" type="text" name="vo.name" class="user_input" value="" usage="notempty" exp="^\S{0,60}$" tip="不大于64位字符, 约20个汉字" onfocus="inputOnFocus(this);" onblur="inputOnBlur(this);"/></td>
			   <td id="nameId_tip_td" class="login_fieldDesc"><i></i><span id="nameId_tip">不大于64位字符, 约20个汉字. 如: 天正教育</span></td>
			</tr>
			<tr>
			...
			<tr>
			   ...
			   <td class="login_field">
			       <html:select name="tenantForm" property="vo.localeid" styleClass="user_input">
			...
			<tr>
			   <td class="field_left"><font color="#ff0000">*</font>联系电话:</td>
			   <td class="login_field">
			       <input id="telephoneId" type="text" name="vo.telephone" class="user_input" value="" usage="" tip="联系电话不能为空，可以填写多个，最多100个字符" onfocus="inputOnFocus(this);" onblur="inputOnBlur(this);"/>
			   </td>
			   <td id="telephoneId_tip_td" class="login_fieldDesc"><i></i><span id="telephoneId_tip">联系电话不能为空，可以填写多个，最多100个字符</span></td>
			</tr>
			<tr>
			   <td></td>
			   <td colspan="2">
    ...
    <!-- 
        ...
        var localeidVar = '<bean:write name="tenantForm" property="vo.localeid"/>';
