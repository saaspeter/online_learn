...
<%@ page import="platformWeb.base.WebConstant,platformWeb.base.KeyInMemoryConstant,commonTool.constant.CommonConstant,commonTool.constant.SysconstConstant" %>
...
<html:html lang="true">
  ...
  <div id="functionLineDiv">
	  <div id="functionButtonDiv">
		  <ul>
			 <li><button type="button" onclick="addRecord('/basicset/sysconst.do?method=addPage');return false;"><bean:message key="platform.commonpage.add"/></button></li>
			 <li><button type="button" onclick="modifyRecord('list','keys','/basicset/sysconst.do?method=editPage&editType=<%=WebConstant.editType_edit %>&vo.sysconstid=','<bean:message key="commonWeb.js.pageAction.modifyRecord.selectOneMsg" bundle="BizKey"/>','<bean:message key="commonWeb.js.pageAction.modifyRecord.oneOnlyMsg" bundle="BizKey"/>');return false;"><bean:message key="platform.commonpage.modify"/></button></li>
