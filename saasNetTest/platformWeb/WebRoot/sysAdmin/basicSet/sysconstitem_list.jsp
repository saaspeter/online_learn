...
<html:html lang="true">
  ...
  <div id="functionLineDiv">
	  <div id="functionButtonDiv">
		  <ul>
			 <li><button type="button" onclick="addRecord('/basicset/sysconstitem.do?method=addPage&vo.sysconstcode=<bean:write name="sysconstitemForm" property="queryVO.sysconstcode"/>');return false;"><bean:message key="platform.commonpage.add"/></button></li>
			 ...
			 <li><button type="button" onclick="goUrl('/basicset/sysconst.do?method=list');return false;"><bean:message key="platform.commonpage.back"/></button></li>
		  </ul>
	  </div>
	  <!-- page list -->
