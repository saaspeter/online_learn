...
<%@ page import="commonTool.constant.CommonConstant,platformWeb.base.WebConstant,platform.constant.ShopfuncConstant" %>
 ...
 <input type="hidden" name="queryVO.shopid" value="<bean:write name="shopfuncForm" property="queryVO.shopid"/>">
  ...
  <div id="DataTableDiv">
    <table class="listDataTable" >
      ...
      <bean:define id="systemcode" name="vo" property="systemid" type="java.lang.String"/>
