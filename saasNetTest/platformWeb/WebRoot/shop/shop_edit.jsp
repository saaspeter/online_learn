	 ...
	 <input type="hidden" name="vo.shopid" value="<bean:write name="shopForm" property="queryVO.shopid"/>">
	  ...
	  <div id="functionBarButtomDiv">
	   ...
	   <div id="content1" style="width:100%;height:230px;">
	       <iframe width="100%" height="100%" src="<%=WebConstant.WebContext %>/shop/listshopvalue.do?queryVO.shopid=<bean:write name="shopForm" property="vo.shopid"/>" scrolling="auto" frameborder="0"></iframe>
	   </div>
