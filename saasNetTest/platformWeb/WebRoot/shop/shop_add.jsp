...
<html:html lang="true">
  ...
  <body>
	...
	<div class="fieldsTitleDiv">申请商店</div>
	...
	<input id="prodcatesId" type="hidden" name="prodcates" value="">
	  ...
	  <div id="fieldDisDiv">
		  <table cellspacing="7" cellpadding="0" border="0" width="100%">
			  <tr>
			     <td class="field_left"><font color="#ff0000">*</font>商店名称:</td>
			     <td class="login_field"><input id="shopnameId" type="text" class="user_input" name="vo.shopname" value="" usage="notempty" exp="^\S{0,60}$" fct="checkShopname('shopnameId')" onfocus="inputOnFocus(this);" onblur="inputOnBlur(this);"/></td>
			     <td id="shopnameId_tip_td" class="login_fieldDesc"><i></i><span id="shopnameId_tip">4 - 20 字母,数字,下划线</span></td>
			  </tr>

              <tr>
			     <td class="field_left"><font color="#ff0000">*</font>商店代号:</td>
			     <td class="login_field"><input id="shopcodeId" type="text" class="user_input" name="vo.shopcode" value="" usage="notempty" exp="^\S{0,60}$" fct="checkShopcode('shopcodeId')" onfocus="inputOnFocus(this);" onblur="inputOnBlur(this);"/></td>
			  ...
			  <tr>
			     ...
			     <td id="emailId_tip_td" class="login_fieldDesc"><i></i><span id="emailId_tip">常用邮箱,用于接受最新消息</span></td>
			  </tr>
			  ...
			  <tr>
			     ...
			     <td class="login_field">
			        <input id="contactnameId" type="text" name="vo.contactname" class="user_input" value="" usage="notempty" onfocus="inputOnFocus(this);" onblur="inputOnBlur(this);"/>
			     </td>
			     <td id="contactnameId_tip_td" class="login_fieldDesc"><i></i><span id="contactnameId_tip">30个字符以内</span></td>
			  </tr>
			  
			  <tr>
			     <td class="field_left"><font color="#ff0000">*</font>商店所在地:</td>
			     <td colspan="2">
			        <table>
			           <tr>
			              <td>
			                  <select id="provinceId" name="province" onchange="selectRegion()" class="font_input"></select>(省)&nbsp;&nbsp;&nbsp;
                              <select id="cityId" name="vo.regioncode" class="font_input" usage="notempty" onfocus="inputOnFocus(this);" onblur="inputOnBlur(this);"></select>(市)
                          </td>
			  ...
			  <tr>
			     ...
			     <td class="login_field">
			        <textarea id="addressId" rows="2" name="vo.address" cols="24" class="user_input" usage="max-length:240" onfocus="inputOnFocus(this);" onblur="inputOnBlur(this);"></textarea>
			     </td>
	  ...
	  <div id="functionBarButtomDiv">
	  	 <ul>
		    <li><button style="font-size:25px;" onclick="if(submitForm('editForm')){newDiv('../pubs/saveDiv.jsp',1,0);} return  false;"><bean:message key="platform.commonpage.save"/></button></li>
			<li><button style="font-size:25px;" onclick="getAndToUrl('backUrl');return false;"><bean:message key="platform.commonpage.back"/></button></li>
		 </ul>
	  </div>
