...
<html:html lang="true">
  ...
  <div id="functionLineDiv">
	  <div id="functionButtonDiv">
		  <ul>
		     <authz:privilege res="/securityManage/addRolePage.do">
			    <li><button type="button" onclick="addRecord('/securityManage/addRolePage.do');return false;">新增</button></li>
			 </authz:privilege>
			 <authz:privilege res="/securityManage/editRolePage.do">
		     ...
		     <authz:privilege res="/securityManage/listRoleResc.do">
