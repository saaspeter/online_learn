...
<html:html lang="true">
  ...
  <body>
	<div class="editPage">
	<html:form styleId="editForm" action="/securityManage/saveRole.do" method="post">
	 ...
	 <input type="hidden" name="vo.id" value="<bean:write name="rolesForm" property="vo.id"/>">
	  <div id="functionLineDiv">
		  <div id="functionBarTopDiv">
			  <ul>
				 <li><button type="button" onclick="if(submitForm('editForm')){newDiv('../pubs/saveDiv.jsp',1,0);} return  false;">保存</button></li>
	  ...
	  <div id="fieldDisDiv">
	     <ul>
			...
			<li>
			   <div class="fieldLabel">角色编码:</div>
			   <div class="field"> 
			     <input type="text" name="vo.code" value="<bean:write name="rolesForm" property="vo.code"/>"/>
			   </div>
			   <div class="fieldDesc"></div>
			</li>
			
			<li>
			   <div class="fieldLabel">上级角色:</div>
			   <div class="field"> 
			     <input type="text" id="Id_upIdName" value="<bean:write name="rolesForm" property="vo.upIdName"/>"  readonly="readonly"/>
			     <button type="button" onclick="newDiv('/securityManage/listRolesSel.do',1,1,600,500);return false;">选择</button>
			      <input type="hidden" id="Id_upId" name="vo.upIdName" value="<bean:write name="rolesForm" property="vo.upIdName"/>"/>
			   </div>
			   <div class="fieldDesc"></div>
			</li>
