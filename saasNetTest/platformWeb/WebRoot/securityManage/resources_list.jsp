  ...
  <div id="firstLineDiv">
      ...
      <div id="searchDiv">资源: 
		...
		<html:select name="resourcesForm" property="queryVO.searchListType" >
		   <html:option value="1">本菜单的权限</html:option>
           <html:option value="2">菜单下所有权限</html:option>
        </html:select>
  ...
  <div id="DataTableDiv">
    <table class="listDataTable" >
      ...
      <tr>
        ...
        <td>
        <a href="javascript:newDiv('/securityManage/viewResourcePage.do?queryVO.id=<bean:write name="vo" property="id"/>',0,1,600,400);">
        ...
        <td><bean:write name="vo" property="visible"/></td>
