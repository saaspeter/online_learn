 ...
 */
public class IteQuesitemTei extends TagExtraInfo {
  ...
  public VariableInfo[] getVariableInfo(TagData data) {
    ...
    String itemvoid = data.getAttributeString("itemvoid");
    String type = data.getAttributeString("type");
    if (itemvoid != null) {
      if (type == null) {
    	  type = "netTest.wareques.vo.Questionitem";
      }
      variables[counter++] = new VariableInfo(itemvoid,
    		                                  type, true,
                                              VariableInfo.NESTED);
    }
