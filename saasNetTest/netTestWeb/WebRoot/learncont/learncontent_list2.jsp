  ...
  <div style="border: 0;margin: 2px;overflow: auto;">
	  <div style="height:auto;">
		  <ul class="tabnav">
		    ...
		    <li class='selectTab'><a href="javascript:void(0)">学习课程</a></li>
			<li><a href="<%=request.getContextPath() %>/exam/listTestinfouser.do?productbaseid=<%=productIdStr %>&contentcateid=<bean:write name="learncontentForm" property="queryVO.contentcateid"/>">考试信息</a></li>
	     ...
	     <ul id="navcate">
                    ...
                    <tr>
                       <td style="text-align: left;">
				          ...
				          <logic:iterate id="learnvo" name="learncontentForm" property="topcatevo.onlinelearnlist" indexId="ind">
						      <img style="width: 23px;cursor: pointer;" src='<%=request.getContextPath() %>/styles/imgs/filetype/<bean:write name="learnvo" property="fileicon"/>' 
	       ...
	       <li>
	           ...
	           <a href="javascript:void(0);" 
		        ...
		        <table id="cateLearnTableId_<%=i %>" class="cateLearnCont">
                   <tr>
                      <td style="text-align: left;">
