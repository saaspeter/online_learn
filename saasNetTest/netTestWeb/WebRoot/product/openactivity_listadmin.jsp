	  ...
	  <div id="functionButtonDiv" <%if(!ableadd){ %> data-toggle="tooltip" data-placement="bottom" data-original-title='只有认证通过的商店才可以发布公开活动，请先认证商店' <%} %> >
		  <ul>
			 <li><button type="button" class="btn btn-success fontBold" style="margin-left:30px;"
			     <%if(ableadd){ %> onclick="addRecord('/product/addOpenactivity.do?showtype=2');" 
  ...
  <div style="width: 100%;margin-bottom: 10px;min-height:300px;">
    <table class="listDataTable">
      ...
      <tr>
        ...
        <td>
            <img src="../styles/imgs/edit.png" title="<bean:message key="netTest.commonpage.modify"/>" style="cursor:pointer;" onclick="goUrl('/product/editOpenactivity.do?vo.activityid=<bean:write name="vo" property="activityid"/>&showtype=2');return false;"/>&nbsp;
