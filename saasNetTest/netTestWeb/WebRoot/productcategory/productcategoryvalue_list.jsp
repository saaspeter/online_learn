...
<html:html lang="true">
  ...
  <div id="functionLineDiv">
	  <div id="functionButtonDiv">
		  <ul>
			 <li><button type="button" onclick="addRecord('/productcategory/addProductcategoryvalue.do?vo.categoryid=<bean:write name="productcategoryvalueForm" property="queryVO.categoryid"/>');return false;"><bean:message key="platform.commonpage.add" bundle="platform.pagemess"/></button></li>
			 <li><button type="button" onclick="modifyRecord('list','keys','/productcategory/editProductcategoryvalue.do?queryVO.categoryvalueid=','<bean:message key="commonWeb.js.pageAction.modifyRecord.selectOneMsg" bundle="BizKey"/>','<bean:message key="commonWeb.js.pageAction.modifyRecord.oneOnlyMsg" bundle="BizKey"/>');return false;"><bean:message key="platform.commonpage.modify" bundle="platform.pagemess"/></button></li>
