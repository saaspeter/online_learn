...
<%@ page import="commonTool.constant.SysconstConstant,netTestWeb.base.WebConstant" %>
...
<html:html lang="true">
  <head>
    ...
    <script language=JavaScript src="<%=WebConstant.WebContext %>/styles/script/checkform.js"></script>
	  ...
	  <div id="fieldDisDiv">
	     <ul>
		    ...
		    <li>
			   ...
			   <div class="field"> 
			      <html:select name="sysconstForm" property="vo.syscode" style="width:300px;"  disabled="<%=show %>">
		    ...
		    <li>
			   ...
			   <div class="field"> 
			       <html:select name="sysconstForm" property="vo.getvalueway" style="width:300px;" disabled="<%=show %>" onchange="setDisable(this)">
