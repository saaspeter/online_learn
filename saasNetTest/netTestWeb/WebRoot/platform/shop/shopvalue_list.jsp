...
<html:html lang="true">
  ...
  <div id="functionLineDiv">
	  <div id="functionButtonDiv">
		  <ul>
			 <li><button type="button" onclick="addRecord('/shop/addshopvaluepage.do?vo.shopid=<bean:write name="shopvalueForm" property="queryVO.shopid"/>');return false;"><bean:message key="platform.commonpage.add" bundle="platform.pagemess"/></button></li>
  ...
  <div id="DataTableDiv">
    <table class="listDataTable" >
      ...
      <tr>
        ...
        <td><a href="javascript:newDiv('/shop/viewshopdescedit.do?queryVO.shopvalueid=<bean:write name="vo" property="shopvalueid"/>&editType=<%=WebConstant.editType_view %>',0,1,500,200);"><bean:write name="vo" property="shopname"/></a></td>
