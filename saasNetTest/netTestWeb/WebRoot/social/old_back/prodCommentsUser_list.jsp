...
<html:html lang="true">
  ...
  <authz:privilege res='<%="/product/editproduct.do?queryVO.productbaseid="+productId %>'>
     <% prodmagpriv = "1"; %>
  </authz:privilege>
  ...
  <div class="navlistBar">
        学习考试&nbsp;&gt;&gt;&nbsp;在线学习
        (&nbsp;课程:<a href="javascript:void(0)" onclick="switchProduct(this);" title="点击切换课程"><%=productname %></a>&nbsp;)
  </div>
  
  	<div style="height:auto; width:100%;">
	  <ul class="tabnav">
	    <li><a href="javascript:void(0)" onclick="goUrl('/product/listcoursepost.do?vo.productbaseid=<%=productidVar %>');return false;">信息台</a></li>
	    <li><a href="javascript:void(0)" onclick="goUrl('/learncont/selfLearncontent.do?productbaseid=<%=productidVar %>&queryVO.contentcateid=<%=contentcateidVar %>&queryVO.contentcatename=<%=contentcatenameVar %>&loadlastlearn=1');return false;">课程资料</a></li>
		<li><a href="javascript:void(0)" onclick="goUrl('/exercise/listUserExer.do?productbaseid=<%=productidVar %>&queryVO.contentcateid=<%=contentcateidVar %>&queryVO.contentcatename=<%=contentcatenameVar %>');return false;">课程练习</a></li>
	    <li><a href="javascript:void(0)" onclick="goUrl('/exam/listTestinfouser.do?productbaseid=<%=productidVar %>&contentcateid=<%=contentcateidVar %>&contentcatename=<%=contentcatenameVar %>');return false;">考试信息</a></li>
	    <li class='selectTab'><a href="javascript:void(0)">提问答疑</a></li>
	  </ul>
	</div>
  ...
  <div id="firstLineDiv" >
      <div id="searchDiv">
        ...
        &nbsp;&nbsp;
         课程章节:
        <input type="text" id="contentcatenameId" name="queryVO.contentcatename" value="<%=contentcatenameVar %>" readonly="readonly" style="width:150px" onclick="selectContcate('<%=productidVar %>');"/>
