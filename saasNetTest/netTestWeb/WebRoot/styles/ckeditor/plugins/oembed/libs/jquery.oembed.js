...
//Deviant Art has this
    ...
    $.fn.oembed.providers = [
        ...
        new $.fn.oembed.OEmbedProvider("qq", "video", ["v.qq.com/page/.+/.+/.+/.+"],"http://static.video.qq.com/TPout.swf?vid=$1&auto=0",
            {templateRegex:/.*v.qq.com\/page\/.+\/.+\/.+\/(.+).html/, embedtag : {width:480,height:400, nocache:1 }}),
