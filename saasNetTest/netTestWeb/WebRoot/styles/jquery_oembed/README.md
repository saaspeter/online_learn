my changes: (peter fan)
a. add support for qq video: support below two types of qq video url:
   http://v.qq.com/page/d/w/i/d0152hcgtwi.html
   http://v.qq.com/boke/page/s/0/6/s0151a5a2t6.html
 
   new $.fn.oembed.OEmbedProvider("qq", "video", ["v.qq.com(/.+)?/page/.+/.+/.+/.+"],"http://static.video.qq.com/TPout.swf?vid=$2&auto=0",
      {templateRegex:/.*v.qq.com(\/.+)?\/page\/.+\/.+\/.+\/(.+).html/, embedtag : {width:700,height:583, nocache:1 }}),
