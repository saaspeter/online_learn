...
<html:html lang="true">
 ...
 <body>
	...
	<div style="height:auto; width:100%; clear:both;">
	  <ul class="tabnav">
	    <li id="tab1" class='selectTab'><a href="javascript:void(0)" onclick="showTab(1,4,'<%=WebConstant.WebContext %>/product/viewproductdesc.do?vo.productbaseid=<%=productbaseidPage %>');return false;">课程介绍</a></li>
		<li id="tab2"><a href="javascript:void(0)" onclick="showTab(2,4,'<%=WebConstant.WebContext %>/prodcont/onlyviewprodcate.do?productbaseid=<%=productbaseidPage %>');return false;">课程目录</a></li>
		<li id="tab3"><a href="javascript:void(0)" onclick="showTab(3,4,'<%=WebConstant.WebContext %>/social/listleavemess.do?queryVO.objecttype=<%=Productbase.ObjectType %>&queryVO.objectid=<%=productbaseidPage %>');return false;">留言信息</a></li>
		<li id="tab4"><a href="javascript:void(0)" onclick="showTab(4,4,'<%=WebConstant.WebContext %>/social/listusecomment.do?vo.objecttype=<%=Productbase.ObjectType %>&vo.objectid=<%=productbaseidPage %>');return false;">课程评价</a></li>
	  </ul>
	</div>
