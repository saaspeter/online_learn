...
<body>
   ...
   <div style="text-align: center;margin: 20px;">
       ...
       <button style="width:15%;height: 40px;font-size: large;margin: 15px;" onclick="goUrl('/customers/editUser.do');">修改密码</button>
       <button style="width:15%;height: 40px;font-size: large;margin: 15px;" onclick="goUrl('/customers/editUser.do');">设定地区语言</button>
   </div>
</body>
