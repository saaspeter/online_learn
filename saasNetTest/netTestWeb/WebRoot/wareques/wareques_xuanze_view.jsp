  ...
  <body>
	<div class="editPage">
	 ...
	 <input id="prodidId" type="hidden" name="vo.productbaseid" value="<bean:write name="warequesForm" property="vo.productbaseid"/>">
	  ...
	  <div>
	      <table class="formTable" style="padding:3px;">
		     <tr>
		        <td align="left" >
	  ...
	  <div style="width:100%;padding-top:2px;margin-top:10px;background-color:#DCEAFC"><font style="font-weight: bold;">题目选项</font></div>
	  <div>
